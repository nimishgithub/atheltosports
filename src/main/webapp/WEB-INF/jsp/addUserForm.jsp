...
<body>
  <form name="registration" class="registartion-form" onsubmit="return formValidation()" action="signup.htm" method="post">
    <table>
      ...
      <tr>
        <td><label id="employee-id-label" for="employee-id-field" style="display:none;">Employee Id:</label></td>
        <td><input type="text" name="employee-id" id="employee-id-field" style="display:none;"
                   placeholder="Employee Id"></td>
      </tr>

      <tr>
        <td colspan="2"><input type="submit" style="margin:0px auto; display:block;"
                               class="signupbtn" value="Register" /></td>
      </tr>
    </table>
    <div class="email">
    ...
    <script>
      ...
      function formValidation() {
        ...
        var isAdmin = document.getElementById("signup-as-admin-checkbox");
        var empId = document.getElementById("employee-id-field");
        ...
        if (isAdmin.checked == true) {
           // check if the employee id is entered.
           if (isNaN(empId.value) || (empId.value.length != 9)) {
             alert("Employee Id must be a 9 digit number");
             empId.focus();
             return false;
           }
        }
      ...
      /*Manage Admin Signup Field*/
      function manageIsAdminFieldVisibility() {
        var isAdmin = document.getElementById("signup-as-admin-checkbox");
        var empIdInput = document.getElementById("employee-id-field");
        var empIdLbl = document.getElementById("employee-id-label");

        if (isAdmin.checked == true) {
          empIdInput.style.display = "block";
          empIdLbl.style.display = "block";
        } else {
          empIdInput.style.display = "none";
          empIdLbl.style.display = "none";
        }
      }
    </script>
  </form>
